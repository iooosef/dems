<template>
  <PrimeDialog
    v-model:visible="displayNewEntry" :modal="true"
  ...
  >
    <template #header>
      <div class="flex-1 flex flex-row justify-between text-black">
        ...
        <button class="p-1 text-dark-500 rounded-lg hover:bg-light-500 focus:shadow-inner focus:outline-none focus:ring focus:ring-offset-0 focus:ring-light-500/50 transition duration-200" @click="displayNewEntry = false">
    ...
    <div class="mt-1 grid grid-cols-2 grid-rows-2 gap-4 text-white">
      ...
      <button class="aspect-square w-40 p-5 flex flex-col items-center rounded-lg bg-primary-500 rounded-lg hover:bg-primary-700 focus:shadow-inner focus:outline-none focus:ring focus:ring-offset-0 focus:ring-primary-500/50 transition duration-200 cursor-pointer">
        ...
        <span class="mt-3 text-lg leading-5 font-medium">New Relief Operation</span>
      </button>
    </div>
  </PrimeDialog>
  <NewEvacueeModal />
